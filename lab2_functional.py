...
def vivod(n, r):
    with open("2.txt") as f:
        ...
        if n == 2:
            return table
        elif n == 3 and (r == 1 or r == 2):
            return stroka_1
        elif n == 4:
            return stroka_1


def zapis(massiv, chislo, lc, g):
    st = ""
    for tt in range(len(massiv)):
        st = st + massiv[tt] + " "
    if lc == 1 and g == 8:
        st = st[:-1] + "\n"
    else:
    ...
    if first_q == "1":
        ...
        while True:
            ...
            if second_q == "1":
                ...
                zapis(zamena, izmena, 1, vvod)

            elif second_q == "2":
                print(vivod(2, 0))
                new_stroka = vivod(3, 2)
